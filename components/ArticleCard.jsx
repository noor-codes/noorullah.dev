  ...
  <div className="block pt-4 mb-2">
    <div className="flex">
      <Link href="/blog/article">
        <a>
          <div className="flex flex-col lg:justify-center h-full md:mr-28">
            ...
            <p className="text-sm text-gray-600 sm:text-base sm:leading-5 md:text-base md:-mt-1 md:tracking-tight lg:text-base line-clamp-2 sm:line-clamp-3">
              {paragraph}
            </p>
          </div>
        </a>
