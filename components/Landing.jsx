    ...
    <>
      ...
      <div className="container min-w-xs mx-auto px-6 sm:px-10 md:max-w-2xl xl:max-w-3xl">
        <div className="mb-2">
          ...
          <div className="flex flex-wrap gap-4 justify-center xs:justify-start text-center mt-8">
            <div>
              <div className="flex justify-center items-center bg-gray-100 h-28 w-28 text-2xl text-gray-600 dark:bg-gray-700 dark:bg-opacity-20 rounded-md">
      ...
      <div className="container min-w-xs mx-auto px-6 sm:px-10 md:max-w-2xl xl:max-w-3xl">
        ...
        <div className="flex flex-wrap gap-5 justify-center xs:justify-start text-center mt-8 mb-10">
          <div>
            <div className="flex justify-center items-center bg-gray-100 h-36 w-36 text-2xl text-gray-600 rounded-md  dark:bg-gray-700 dark:bg-opacity-20">
