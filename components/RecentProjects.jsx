...
const RecentProjects = () => {
  return (
    <>
      <div className="flex flex-wrap -mx-5 justify-center xs:justify-start text-center mt-8 mb-10">
        <div>
          <div className="flex justify-center items-center m-5 bg-gray-100 h-28 w-28 text-2xl text-gray-600 rounded-md dark:bg-gray-800 dark: dark:text-gray-400 ">
