    ...
    <>
      <div className="flex flex-wrap -mx-3 justify-center xs:justify-start text-center mt-8 mb-10">
        <div>
          ...
          <div className="text-sm text-gray-400 mt-2 ">Inventory</div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm text-gray-400 mt-2">My Portfolio</div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm text-gray-400 mt-2">CarBidNow</div>
        </div>
      </div>
    </>
  )
