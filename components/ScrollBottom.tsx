...
const Icon = () => {
  //. Figure out a way to animate the SVG out.
  //. AnimatePresence won't work because the unmount login lives inside ScrollButton.
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, x: -10 }} exit={{ opacity: 0 }}>
