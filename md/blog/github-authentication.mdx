...
Imagine if you're password is somehow lost and you are the maintainer of a project that
...
2.  ** Secure Socket Shell (SSH): **
    ...
    **Next** we have to go to `.ssh` folder and open `id_rsa.pub` file and
    copy they key. If you can't see the folder, It's because it's hidden by default.
