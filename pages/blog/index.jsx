...
const Blog = () => (
  <div>
    <PageName name="Blog" />
    <div className="container min-w-xs mx-auto px-6 sm:px-10">
      <main className="mx-auto md:pt-5">
        <div className="mt-8 mb-4">
          <h1 className="font-bold leading-normal mb-5 text-3xl xs:text-4xl xs:leading-10 md:text-6xl md:mb-6 lg:mb-6 lg:leading-snug lg:text-5xl">
            All Blog Posts
          </h1>
        ...
        <div className="border-b-2 border-gray-100 -mt-5 md:-mt-2">&nbsp;</div>
